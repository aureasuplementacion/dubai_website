...
export const specialties: Specialty[] = [
  {
    ...
    shortDescription: { es: "Información general sobre opciones capilares, siempre sujeta a valoración profesional.", en: "General information about hair options, always subject to professional assessment." },
    description: { es: "Conoce opciones capilares y prepara una conversación informativa con el equipo clínico responsable.", en: "Explore hair options and prepare an informational conversation with the responsible clinical team." },
    services: [
  ...
  },
  {
    ...
    shortDescription: { es: "Información general sobre opciones dentales de proveedores independientes.", en: "General information about dental options from independent providers." },
    description: { es: "Conoce opciones dentales y las preguntas que puedes plantear al centro responsable.", en: "Explore dental options and the questions you can ask the responsible centre." },
    services: [
  ...
  },
  {
    ...
    shortDescription: { es: "Información general para valorar opciones estéticas con calma.", en: "General information to explore aesthetic options with care." },
    description: { es: "Conoce opciones quirúrgicas y prepara tus preguntas antes de hablar con el equipo sanitario responsable.", en: "Explore surgical options and prepare your questions before speaking with the responsible healthcare team." },
    services: [
  ...
  },
  {
    ...
    description: { es: "Información inicial sobre opciones bariátricas para preparar una conversación con el equipo sanitario responsable.", en: "Initial information about bariatric options to prepare a conversation with the responsible healthcare team." },
    services: [
