...
import { deleteLead, updateLead, getAdminLeads, type AdminLead, type LeadFilters } from "@/lib/actions/admin-leads";
...
export function AdminCrmPanel({ initialLeads, isAdmin }: { initialLeads: AdminLead[]; isAdmin: boolean }) {
