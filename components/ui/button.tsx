...
const toneClasses: Record<ButtonTone, string> = {
  primary: "bg-sapphire text-white shadow-soft hover:bg-sapphire-dark",
  secondary: "border border-sapphire bg-white text-sapphire hover:bg-surface",
  ghost: "text-sapphire underline decoration-champagne decoration-2 underline-offset-8 hover:text-sapphire-dark",
  danger: "bg-danger text-white hover:brightness-95",
};

const baseClasses = "inline-flex min-h-11 items-center justify-center gap-2 rounded-full px-5 py-3 text-sm font-semibold transition duration-base ease-standard disabled:cursor-not-allowed disabled:opacity-60";
